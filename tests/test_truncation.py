#!/usr/bin/env python3
"""
Test script to verify that TruncationError is raised when responses are truncated
"""
...
print("=" * 60)
print("Testing TruncationError with max_tokens = 100")
print("=" * 60)

try:
    result = convert_pdf_to_markdown(
        pdf_path="input/basic-text.pdf",
        output_path="test_output_truncation.md",
